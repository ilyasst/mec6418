...
phi_k = divide( C,delta_kMT_s_list )
...
phi_mu = divide( C,delta_muMT_s_list )

# Summations
sumsk = 0
for i in range(0, n):
	sumsk_int = ( phi_k[i]*sy.exp(-to[i]*t))
	sumsk = sumsk + sumsk_int[i]
